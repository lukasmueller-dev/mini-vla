// GENERATED by scripts/gen-embeddings-data.mjs — do not edit.
// Metadata for the pretrained GloVe embedding assets in public/vla/ (see
...
export const CORE_VOCAB: Record<string, number> = {
  "the": 2,
  "of": 3,
  "a": 7,
  "for": 8,
